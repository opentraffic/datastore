...
/**
 * Bucket durations into a byte by using a floating-point format with the 2 high
 * bits indicating a step size and the lower 6 bits indicating the number of
 * steps.
 */
